# -*- coding: utf-8 -*-
"""Inyecta el dataset en la pagina de resumen y la escribe."""
import os
BASE = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
tpl = open(os.path.join(BASE, "src/modulo1/resumen.tpl.html"), encoding="utf-8").read()
...
sal = os.path.join(BASE, "salidas/resumen.html")
